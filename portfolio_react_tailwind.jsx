...
export default function App() {
  return (
    <div className="font-inter bg-gradient-to-br from-gray-50 via-slate-100 to-white min-h-screen text-gray-900">
        ...
        <section className="grid md:grid-cols-2 gap-8 items-center mb-16">
          <div className="bg-white rounded-2xl shadow-lg p-8 border border-slate-200">
            ...
            <div className="flex gap-4 flex-wrap">
              <a href="#projects" className="px-6 py-3 rounded-full bg-gradient-to-r from-indigo-600 to-cyan-600 text-white font-semibold shadow-lg hover:scale-105 transition">View My Work</a>
              <a href="mailto:prashanthche@gmail.com" className="px-6 py-3 rounded-full border-2 border-indigo-600 text-indigo-700 font-semibold hover:bg-indigo-50 transition">Contact Me</a>
              <a href="Resume_Prashanth_Sankar_Updated.pdf" download className="flex items-center gap-2 px-6 py-3 rounded-full bg-gradient-to-r from-indigo-600 to-cyan-600 text-white font-semibold shadow-lg hover:scale-105 hover:shadow-xl transition"><FaFileAlt /> Download My Resume</a>
            </div>
          </div>
